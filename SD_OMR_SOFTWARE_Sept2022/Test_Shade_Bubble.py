...
# biggestContour=utility.getCornerPoints(rectCon[4]) #TOP: SUCCESFUL
# biggestContour=utility.getCornerPoints(rectCon[8]) #TOP: SUCCESFUl
# biggestContour=utility.getCornerPoints(rectCon[6]) #TOP: SUCCESFUL
# biggestContour=utility.getCornerPoints(rectCon[2]) #TOP: SUCCESFUl
# biggestContour=utility.getCornerPoints(rectCon[3]) #BOTTOM: SUCCESFUl
# biggestContour=utility.getCornerPoints(rectCon[7]) #BOTTOM: SUCCESFUl
# biggestContour=utility.getCornerPoints(rectCon[5]) #BOTTOM: SUCCESFUl
biggestContour=utility.getCornerPoints(rectCon[1]) #BOTTOM: SUCCESFUl
#2nd BIGGEST CONTOUR (RESULT ZONE)
gradePoints= utility.getCornerPoints(rectCon[0])
